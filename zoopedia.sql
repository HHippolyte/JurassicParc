...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  ven. 06 avr. 2018 à 19:19
...
-- Procédures
--
DROP PROCEDURE IF EXISTS `SP_espaces_correspondant_p_numanimal`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_espaces_correspondant_p_numanimal` (IN `p_numanimal` INT UNSIGNED)  NO SQL
SELECT espa.NUM_ESPACE, espa.LIBELLE_ESPACE, espa.LOCALISATION_ESPACE
								FROM espace AS espa
								WHERE 
								TYPE_ESPACE=
								(SELECT MILIEU_DE_VIE FROM espece AS espe INNER JOIN animal AS a ON espe.CODE_ESPECE=a.CODE_ESPECE
								AND a.NUM_ANIMAL=p_numanimal)

								AND 
								espa.TAILLE_ESPACE>=(
								SELECT espe.ESPACE_MIN_DE_VIE FROM espece AS espe INNER JOIN animal AS a ON espe.CODE_ESPECE=a.CODE_ESPECE
								AND a.NUM_ANIMAL=p_numanimal)
								AND 
								espa.TEMPERATURE_MINIMUM_ESPACE>=(
								SELECT espe.TEMPERATURE_MIN_ESPECE FROM espece AS espe INNER JOIN animal AS a ON espe.CODE_ESPECE=a.CODE_ESPECE
								AND a.NUM_ANIMAL=p_numanimal)

								AND
								espa.TEMPERATURE_MAXIMUM_ESPACE<=(
								SELECT espe.TEMPERATURE_MAX_ESPECE FROM espece AS espe INNER JOIN animal AS a ON espe.CODE_ESPECE=a.CODE_ESPECE 
								AND a.NUM_ANIMAL=p_numanimal)

								AND 
								espa.SURCAPACITE_ESPACE=0$$
...
(21, 22, 1, 2, '2018-03-29 00:00:00', NULL, 10),
(22, 23, 1, 2, '2018-03-29 00:00:00', NULL, 10),
(23, 24, 1, 2, '2018-03-29 00:00:00', NULL, 10),
(24, 25, 1, 2, '2018-03-29 00:00:00', NULL, 10),
(25, 29, 1, 2, '2018-03-29 00:00:00', NULL, 10),
(26, 30, 3, 2, '2018-03-29 00:00:00', NULL, 10),
(27, 31, 2, 2, '2018-03-29 00:00:00', NULL, 10),
(28, 32, 1, 2, '2018-03-29 00:00:00', NULL, 10),
(29, 33, 1, 2, '2018-03-29 00:00:00', NULL, 10),
(30, 34, 4, 2, '2018-03-29 00:00:00', NULL, 10),
(31, 34, 4, 2, '2018-03-29 00:00:00', NULL, 10),
(32, 36, 2, 2, '2018-03-29 00:00:00', NULL, 10),
(33, 36, 2, 2, '2018-03-29 00:00:00', NULL, 10),
(34, 38, 3, 2, '2018-03-29 00:00:00', NULL, 10),
(35, 38, 2, 2, '2018-03-29 00:00:00', NULL, 10),
(36, 38, 2, 2, '2018-03-29 00:00:00', NULL, 10),
(37, 38, 2, 2, '2018-03-29 00:00:00', NULL, 10),
(38, 38, 2, 2, '2018-03-29 00:00:00', NULL, 10),
(39, 38, 2, 2, '2018-03-29 00:00:00', NULL, 10),
(40, 38, 2, 2, '2018-03-29 00:00:00', NULL, 10),
(41, 38, 2, 2, '2018-03-29 00:00:00', NULL, 10),
(42, 38, 2, 2, '2018-03-29 00:00:00', NULL, 10),
(43, 38, 2, 2, '2018-03-29 00:00:00', NULL, 10),
(44, 38, 2, 2, '2018-03-29 00:00:00', NULL, 10),
(45, 38, 2, 2, '2018-03-29 00:00:00', NULL, 10),
(46, 38, 2, 2, '2018-03-29 00:00:00', NULL, 10),
(47, 38, 2, 2, '2018-03-29 00:00:00', NULL, 10),
(48, 52, 2, 2, '2018-03-29 00:00:00', NULL, 10),
(49, 52, 2, 2, '2018-03-30 00:00:00', NULL, 10),
(50, 52, 2, 2, '2018-03-31 00:00:00', NULL, 10),
(51, 52, 2, 2, '2018-04-06 00:00:00', NULL, 10);
...
CREATE TABLE IF NOT EXISTS `placement` (
  ...
  `DATE_DEBUT_PLACEMENT` date NOT NULL,
  `DATE_FIN_PLACEMENT` date DEFAULT NULL,
...
(1, 1, 2, '2011-03-14', NULL),
(2, 1, 3, '2018-03-24', NULL);
...
(21, 'Pourin', 'Maurice', 'Enfant', '78009', 'paumau@gmail.com'),
(22, 'Marre', 'Dodo', 'Enfant', '45009', 'mareodod@yaoo.fr'),
(23, 'Prunelle', 'Marine', 'Enfant', '78009', 'uggo@igui'),
(24, 'Moussin', 'Fanny', 'Enfant', '56009', 'gjgjhg@gvj'),
(25, 'Pounil', 'Marc', 'Enfant', '56009', 'xqhgx@ohoho'),
(26, 'Moulin', 'Manon', 'Enfant', '67009', 'gdized@zedg'),
(27, 'Nomlio', 'Noui', 'Enfant', '78009', 'zdzd@zdz'),
(28, 'Poulllon', 'Lucinda', 'Enfant', '67009', 'dzz@yahoo'),
(29, 'Moupon', 'Caca', 'Enfant', '09880', 'zedze@ddzedze.fr'),
(30, 'Moulino', 'Suzie', 'Adulte', '87009', 'dzued@zda.fr'),
(31, 'Pruneau', 'Amelie', 'Etudiant', '67009', 'dzed@deaa.fr'),
(32, 'Manu', 'Emma', 'Enfant', '90777', 'zeda@adz.fr'),
(33, 'Moulinas', 'Guillaume', 'Enfant', '90888', 'zead@dzed.fr'),
(34, 'Monin', 'Lisa', 'Senior', '45009', 'dzede@uide.fr'),
(36, 'dcdcd', 'dccd', 'Etudiant', '69001', 'fdfd@gmail.com'),
(38, 'egrfghjj', 'fghj', 'Adulte', '69008', 'kzjebfv@gmail.com'),
(52, 'egrfghjj', 'f', 'Etudiant', '69001', 'humberthippolyte@gmail.com');
